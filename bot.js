...
console.log(`
  ...
  console.log(`
    ...
    // Function to show a live countdown timer in console
      ...
      while (true) {
        try {
          ...
          if (letsRollClicked) {
            ...
            await browser.close();
            console.log("🔄 Cycle complete. Sleeping for 24 hours...");
